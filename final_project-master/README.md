...
python runsim.py grid_search

for ziegler-nichols tuning:
python runsim.py zn_tune

for vertical PID constant metric comparison:
python runsim.py pid_compare

for just observing the performance of current vertical pid constants:
python runsim.py step_test
```
